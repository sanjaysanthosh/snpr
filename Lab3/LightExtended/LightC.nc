...
implementation {
	...
	components new HamamatsuS10871TsrC() as LightTsr;//Solar radiation sensor
	components new  SensirionSht11C() as TemperateHumiditySensor;//humidity - temperature sensor
